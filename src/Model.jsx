...
function Render () {
  return (
  <Canvas className="my-canvas" shadows dpr={[1, 2]} camera={{ fov: 45 }} style={{ position: 'absolute'/*, width: '600px', height: '600px' */ }} >
      <ambientLight />
...
<OrbitControls speed={1.5} global zoom={0.5} polar={[-0.1, Math.PI / 4]}/>
  <Stage environment={null} intensity={1} contactShadowOpacity={0.1} shadowBias={-0.0015}>
    <Model scale={0.11} style={{ pointerEvents: 'none' }}></Model>
  </Stage>
  </Canvas>
  )
}
